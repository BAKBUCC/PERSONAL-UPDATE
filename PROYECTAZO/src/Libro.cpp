...
Libro::Libro(Menu menu)
{
    cout << "BIENVENIDO, elige un estilo..." << endl;
    mostrar_estilos(menu);
}
void Libro::mostrar_estilos(Menu menu)
{
    cout << "(1)Romance" << endl;
    cout << "(2)Drama" << endl;
    cout << "(3)Fantasia" << endl;
    cout << "(4)Gotico" << endl;
    cout << "(5)volver a menu" << endl;
    int x;
    cin >> x;
    system("cls");
    if(x==1){
...
void Libro::fantasia1(Menu menu)
{
    cout << endl;
...
void Libro::fantasia2(Menu menu)
{
    cout << endl;
...
void Libro::fantasia3(Menu menu)
{
    cout << endl;
